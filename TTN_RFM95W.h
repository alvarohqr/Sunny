  ...
  static const PROGMEM u1_t NWKSKEY[16] = { 0x44, 0x53, 0xD5, 0x7A, 0x14, 0xE3, 0x4A, 0xF8, 0xF4, 0xCA, 0xC0, 0x9C, 0x90, 0xE2, 0x05, 0xFD };
  
  // LoRaWAN AppSKey, application session key (MSB format)
  static const u1_t PROGMEM APPSKEY[16] = { 0xA9, 0xE8, 0x32, 0x89, 0x39, 0x4E, 0x2C, 0x5A, 0x79, 0xF3, 0x3D, 0xEE, 0xD9, 0x45, 0x0C, 0x50 };
  
  // LoRaWAN end-device address (DevAddr)
  static const u4_t DEVADDR = 0x260C7052 ; 
