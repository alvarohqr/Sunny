...
Adafruit_BMP085::Adafruit_BMP085() { i2c_dev = NULL; }
...
int32_t Adafruit_BMP085::readSealevelPressure(float altitude_meters) {
  ...
  return (int32_t)(pressure / powf(1.0 - altitude_meters / 44330, 5.255));
}
...
float Adafruit_BMP085::readAltitude(float sealevelPressure) {
  ...
  altitude = 44330 * (1.0 - powf(pressure / sealevelPressure, 0.1903));
